...
const googleErrors: Record<string, string> = {
  ...
  invitation_required: "A valid invitation is required to create an account right now.",
    ...
    <main className="auth-page login-page">
      <div className="login-layout">
        ...
        <section className="auth-card login-card" aria-labelledby="login-heading">
          ...
          {!challengeToken && setupStatus.registration_mode === "open" && <p className="auth-signup-link">Don't have an account? <Link to="/signup">Create account.</Link></p>}
